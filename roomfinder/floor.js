...
export class Floor extends Entity{
    ...
    constructor(name, roomsArray, optionalX, optionalY){
        ...
        const material = new THREE.MeshStandardMaterial({color: 0xC4D4DF, flatShading: true, transparent:true, opacity:0.5});
        ...
        if(optionalX !== undefined && optionalY !== undefined){
            label.position.set(optionalX/2+0.1, 0,0);
            label.rotateY(Math.PI/2);
            label2.position.set(-optionalX/2-0.1, 0,0);
